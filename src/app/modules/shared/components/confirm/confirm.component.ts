...
export class ConfirmComponent implements OnInit {
  ...
  /**
   * Procedure that closes this view once the "NO" button from this Dialog is pressed.
   */
  onNoClick() {
  ...
  /**
   * Procedure that deletes the requested Category or Product once the button "YES" is pressed.
   */
  delete() {
    if (this.data != null) {
